...
describe('SystemService', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    svc = new SystemService(mockRepo);
  });

  it('getMeta delegates to repo', async () => {
  ...
  it('getCashByChain delegates to repo', async () => {
