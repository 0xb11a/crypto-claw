...
openclaw config set 'tools.exec' '{"security":"allowlist","ask":"off","safeBins":["node scripts/*"],"safeBinProfiles":{"node scripts/*":{"minPositional":1,"maxPositional":10,"deniedFlags":["-e","--eval","--input-type"]}}}' --strict-json
