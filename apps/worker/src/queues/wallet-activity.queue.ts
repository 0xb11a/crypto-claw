/**
 * wallet-activity.queue.ts — BullMQ queue naming for wallet-activity jobs.
 *
 * Re-exports `WALLET_ACTIVITY_QUEUE` from the shared domain location
 ...
 *   @Processor decorator in ActivityWalletsProcessor. No nonce-collision concern
...
export { WALLET_ACTIVITY_QUEUE, WALLET_ACTIVITY_JOB_OPTIONS } from '@cclaw/wallets';
